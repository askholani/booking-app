            ...
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <div class="flex items-center justify-center gap-x-2">
                    <img width="40" height="40"
                        src="https://img.icons8.com/external-vitaliy-gorbachev-fill-vitaly-gorbachev/60/external-joystick-cyber-monday-vitaliy-gorbachev-fill-vitaly-gorbachev.png"
                        alt="external-joystick" />
                    <span class="text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">STATIONS</span>
                </div>
        ...
        <ul class="space-y-2 font-medium">
            <li>
                ...
                <a href="{{ route('admin.booking.index') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Booking Management </span>
                </a>
            </li>
            <li>
